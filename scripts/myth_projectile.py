...
LpgrFmt = ('Lpgr', [
    ...
    ('h', 'target_number_lower_bound', codec.Simple),
    ('h', 'target_number_delta', codec.delta('target_number_lower_bound')),
    ('l', 'radius_lower_bound', codec.World),
    ('l', 'radius_delta', codec.world_delta('radius_lower_bound')),
    ('i', 'expiration_time_lower_bound', codec.Time),
    ('i', 'expiration_time_delta', codec.time_delta('expiration_time_lower_bound')),
    ('h', 'transfer_mode'),
    ('h', 'height_offset', codec.World),
    ('h', 'startup_transition_time_lower_bound', codec.Time),
    ('h', 'startup_transition_time_delta', codec.time_delta('startup_transition_time_lower_bound')),
    ('h', 'ending_transition_time_lower_bound', codec.Time),
    ('h', 'ending_transition_time_delta', codec.time_delta('ending_transition_time_lower_bound')),
    ('i', 'duration_lower_bound', codec.Time),
    ('i', 'duration_delta', codec.time_delta('duration_lower_bound')),
    ('h', 'starting_hscale0'),
    ('h', 'starting_hscale1'),
    ('h', 'starting_vscale0'),
    ('h', 'starting_vscale1'),
